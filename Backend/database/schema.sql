-- ============================================================
-- ILCMS Database Schema
-- ============================================================

CREATE DATABASE IF NOT EXISTS ilcms_db
...
-- ------------------------------------------------------------
-- PasswordResetRequest  (User Story 2: Forgot Password)
-- ------------------------------------------------------------
...
-- Password: admin123  (bcrypt hash — run seed.js to insert with real hash)
-- The placeholder below is replaced by seed.js at first run.
-- DO NOT insert plain-text passwords here.
-- INSERT INTO `User` (username, full_name, password, email, role_id, status)
-- VALUES ('admin', 'System Admin', '<bcrypt_hash>', 'admin@ilcms.local', 1, 'Active');
